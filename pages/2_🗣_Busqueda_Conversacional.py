...
from weaviate_interface_v3_spa import WeaviateClient, WhereFilter
from prompt_templates_spa import question_answering_prompt_series_spa
from openai_interface_spa import GPT_Turbo
from openai import BadRequestError
from app_features_spa import (convert_seconds, generate_prompt_series, search_result,
...
def main():
    ...
    st.image('./assets/cervezas-mahou.jpeg', width=400)
